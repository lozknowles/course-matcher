...
function setMode(mode){
  ...
  const heroCopy={
    launch:['Lincoln College demonstration suite','Student success','Seven connected demonstrations for course discovery, student support, supervised automation, enrolment and career pathways.'],
