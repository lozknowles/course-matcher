...
function subview(name) {
  ...
  if (name === 'careers') return shell('Career Paths', `${card('Mechanical engineering technician', '<p>A discussion example, not a College-approved mapping. The National Careers Service describes possible further study towards engineering.</p><a href="https://nationalcareers.service.gov.uk/job-profiles/mechanical-engineering-technician" target="_blank" rel="noopener">Official National Careers Service profile</a>')}${card('Explore careers', '<a href="https://nationalcareers.service.gov.uk/explore-careers" target="_blank" rel="noopener">Official general careers route</a>')}${card('Skills England reference explorer', '<p>Browse a cached Skills England reference snapshot. Course associations are illustrative and unreviewed, not College-approved mappings.</p><a class="button" href="./careers.html">Open the Skills England reference explorer</a>')}`);
