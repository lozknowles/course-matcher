...
assert_public_contains "$PUBLIC_URL/digital-student-journey.html" '20260922-yellow-red-menu'
...
assert_public_contains "$PUBLIC_URL/journey-views.js" 'DON’T KNOW<br>WHAT TO CHOOSE?'
assert_public_contains "$PUBLIC_URL/journey-views.js" 'journey-capacity'
