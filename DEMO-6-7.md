...
- The recovered pathway implementation came from local revision `09a06bf`, following implementation `b1183dac950e60b3c49c3271d51c9b65ca1e87df`. Its regional pay reference retains its original retrieval and cell provenance.
- ONS ASHE Table 15, 2025 provisional: East Midlands workplace-based median annual gross pay for full-time employee jobs, matched by exact four-digit SOC 2020. It describes a broader occupation group, not starting pay or a guaranteed salary for the selected role. Suppressed, unavailable and high-CV estimates are not displayed as numbers.
